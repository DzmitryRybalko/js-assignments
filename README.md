...
## Javascript Assignments  [![Build Status](https://travis-ci.org/DzmitryRybalko/js-assignments.svg?branch=master)](https://travis-ci.org/DzmitryRybalko/js-assignments)
...
* Edit local README.md file and update all links (just replace all occurrences of `'DzmitryRybalko'` with your account name).
...
```
* Open https://github.com/DzmitryRybalko/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/DzmitryRybalko/js-assignments/builds).
